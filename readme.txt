...
[Main Page](https://wpfactory.com/item/amount-left-free-shipping-woocommerce/?utm_source=wporg&utm_medium=organic&utm_campaign=readme "Main Page") | [Demo](https://freeshippingbar.instawp.xyz/ "Demo") | [Support Forum](https://wpfactory.com/support/item/amount-left-free-shipping-woocommerce/?utm_source=wporg&utm_medium=organic&utm_campaign=readme "Support Forum") | [Documentation & How to](https://wpfactory.com/docs/amount-left-free-shipping-woocommerce/?utm_source=wporg&utm_medium=organic&utm_campaign=readme "Documentation & How to")
...
1. Show messages on different locations telling customers how much is remaining to get Free Shipping.

2. Customize options on when the messages appear (below specific threshold) or if specific shipping methods are disabled.

3. Show amount left for free shipping messages using widgets & shortcode, meaning you can -literally- show it in any location on your store.

4. Manually select the minimum amount to be eligible for free shipping, overwriting the amount set by WooCommerce standard free shipping (or any other non-standard method you use for free shipping)
...
### 🚀 Show messages anywhere on your store ###
...
= 2.5.2 - 28/02/2026 =
* Fix - Fixed HTML sanitization from amount left message.
...
[View older changelog entries](https://plugins.svn.wordpress.org/amount-left-free-shipping-woocommerce/trunk/changelog-older.txt)
